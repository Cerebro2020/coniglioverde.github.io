...
export default function(){
  ...
  scene.fog = new THREE.Fog(0x008888, 10, 40);
  ...
  speakerLoader.load(    
    './3d/humans/Low_person_3.glb',
     function (glt) {
      ...
      speakerFotogramma.position.set(0,-8,10);
  ...
  let rotations = [
    ...
    {moveTime: 20, waitTime: 0, pos: {x:0,y:0, z:0}},
    {moveTime: 40, waitTime: 0, pos: {x:0,y:0, z:2*Math.PI}},
